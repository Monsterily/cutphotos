...
public class CircleHighlightView{
    ...
    public static final int DEFAULT_HIGHLIGHT_COLOR = 0xFF33B5E5;
    public static final float HANDLE_RADIUS_DP = 12f;
    public static final float OUTLINE_DP = 2f;
    ...
    public View viewContext; // View displaying image
    public boolean showThirds;
    public int highlightColor;

    public ModifyMode modifyMode = ModifyMode.None;
    public HandleMode handleMode = HandleMode.Changing;
     ...
     * @return
     */
    int getHitOnCircle(float x, float y) {
